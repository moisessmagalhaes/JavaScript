...
internamente. Se o valor fornecido foi o sorteado, retorne "Parabéns! O número sorteado foi o X". Se não for
igual, retorne "Que pena! O número sorteado foi o X". X é o número que foi sorteado.
Exemplos:
...
function funcaoDaSorte(numero) {
    ...
    let max = 60
        ...
        numeroSorteado = Math.floor(valor)
